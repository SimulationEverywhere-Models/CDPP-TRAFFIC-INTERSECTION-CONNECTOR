[top]
components : intersection_1
components : intersection_2
components : intersection_connector

out : time_output  
Link : carOut@intersection_1 carIn@intersection_connector
Link : carOut@intersection_connector carIn@intersection_2



[intersection_connector]
components : connection_generator@ConnectionGenerator
components : connector_queue@Queue
components : connector_controller@IntersectionController

in : carIn
out : carOut 
Link : carIn in@connection_generator

Link : out@connection_generator in@connector_queue
Link : out@connector_queue in@connector_controller
Link : busy@connector_controller stop_out@connector_queue
Link : out@connector_controller done@connector_queue
Link : out@connector_controller carOut
...
out : carOut
Link : carOut@traffic_light_a carOut
...
in : carIn
Link : carIn carIn@traffic_light_a
...
components : lane_queue_a@GenericQueue intersection_a  
