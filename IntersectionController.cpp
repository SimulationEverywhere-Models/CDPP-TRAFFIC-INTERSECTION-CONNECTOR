...
//////////////////////////////////////////////////////////////////////////////////
/*******************************************************************
* Description: if the input to the intersection connector is block
* 			   then send an output busy to intersection_queue
********************************************************************/
//	if(port==block)
//	{
//		inputPort = "block";
//		if(msg.value()==1) // stop_in==1
//		{
