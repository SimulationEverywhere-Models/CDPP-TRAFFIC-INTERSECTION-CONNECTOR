...
out : out goosfand
Link : kharchang@intersection_1 goosfand
Link : kharchang@intersection_1 in@connection_generator
...
out : carOut kharchang
Link : kharchang@traffic_light_a kharchang
...
components : lane_a
in : signal
out :  light throughput curlength avelength kharchang
...
Link : throughput@collector_a kharchang
